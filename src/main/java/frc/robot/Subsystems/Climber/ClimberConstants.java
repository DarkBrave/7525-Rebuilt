...
public class ClimberConstants {
	...
	public static final int LEFT_CLIMBER_MOTOR_ID = 23;
	...
	public static final Angle CLIMBING_POSITION = Rotations.of(227.704);
	public static final double IDLE_SETPOINT = 0;
	public static final double EXTEND_SETPOINT = 227.704;
	public static final double RETRACT_SETPOINT = 0;
	public static final double HOLD_SETPOINT = 150;
