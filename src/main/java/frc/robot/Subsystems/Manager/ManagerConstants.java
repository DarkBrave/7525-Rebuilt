...
public class ManagerConstants {
	...
	public static final double SHOOTER_TARGET_ANGLE_DIFF_DEGREES = 2;
	public static final double CLOSE_TO_NOT_MOVING_MPS = 0.25;
	public static final double CLOSE_TO_WHEEL_SETPOINT = 2;
